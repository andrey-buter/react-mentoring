...
`;const m=s.a.div`
	...
	align-items: center;
`;var p=()=>n.a.createElement(m,null,n.a.createElement(d,null)),v=r.p+"Assets/images/header-background.52c3af2075e83fb65aa7ee0104697c81.jpg";function b(e){return{type:"UPDATE_WORDS",payload:e}}function h(e){return{type:"OPEN_MODAL",payload:e}}const f=s.a.button`
	position: absolute;
	right: 150px;
	top: 20px;
`;var E=Object(o.b)(null,e=>({openModal:t=>e(h({id:t,data:null}))}))(e=>n.a.createElement(f,{onClick:()=>e.openModal("addNewMovie")},"+ Add a movie"));const g=s.a.button`
	position: absolute;
	right: 0;
	top: 20px;
