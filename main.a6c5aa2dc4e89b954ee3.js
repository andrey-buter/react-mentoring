...
`;const m=s.a.div`
	...
	align-items: center;
`;var p=()=>n.a.createElement(m,null,n.a.createElement(d,null)),v=r.p+"Assets/images/header-background.52c3af2075e83fb65aa7ee0104697c81.jpg";function h(e){return{type:"UPDATE_WORDS",payload:e}}function b(e){return{type:"OPEN_MODAL",payload:e}}const E=s.a.button`
	position: absolute;
	right: 150px;
	top: 20px;
`;var g=Object(o.b)(null,e=>({openModal:t=>e(b({id:t,data:null}))}))(e=>n.a.createElement(E,{onClick:()=>e.openModal("addNewMovie")},"+ Add a movie"));const f=s.a.button`
	position: absolute;
	right: 0;
	top: 20px;
`;var y=Object(o.b)(null,e=>({openModal:t=>e(b({id:t,data:null}))}))(e=>n.a.createElement(f,{onClick:()=>e.openModal("addNewWord")},"+ Add a word"));var w=s.a.button`
	background: none;
...
`;var ce=Object(o.b)(null,e=>({openModal:(t,r)=>e(b({id:t,data:r}))}))(e=>{const{word:t,openModal:r}=e;return n.a.createElement(oe,null,n.a.createElement("div",null,n.a.createElement(ie,{to:"/words/"+t.id},n.a.createElement("div",null,t.selection," - ",t.translation)),n.a.createElement("div",null,n.a.createElement("a",{href:t.uri,target:"_blank",title:t.uri},t.uri))),n.a.createElement("div",{className:"buttons"},n.a.createElement(w,{onClick:e=>{e.preventDefault(),r("editWord",t)}},"Edit"),n.a.createElement(w,{onClick:e=>{e.preventDefault(),r("removeWord",t)}},"Delete")))});var ue={groupWords(e,t){switch(e){case _.Site:return this._groupWordsBySite(t);case _.SameWord:return this._groupWordsTheSameWord(t);case _.All:default:return this._groupWordsByAll(t)}},_groupWordsByAll:e=>[{id:"All",words:e}],_groupWordsBySite(e){const t=e.reduce((e,t)=>(e[t.uri]||(e[t.uri]=[]),e[t.uri].push(t),e),{});return Object.keys(t).map(e=>({id:e,words:t[e]}))},_groupWordsTheSameWord(e){const t=e.reduce((e,t)=>{const r=(t.originWord||t.selection.trim()).replace(/es$/,"").replace(/s$/,"").replace(/ed$/,"e");return e[r]||(e[r]=[]),e[r].push(t),e},{}),r=Object.keys(t).map(e=>{const r=t[e];return{id:`(${r.length}) ${e}`,words:r}});return r.sort((e,t)=>e.words.length>t.words.length?-1:1),r}};const se=s.a.ul`
	display: flex;
	flex-wrap: wrap;
`;var de=Object(o.b)(e=>{const{wordsState:t}=e;return Object.assign({},t)})(e=>{const{words:t,groupBy:r}=e,{searchQuery:l}=Object(j.h)(),o=Object(a.useCallback)((e,t)=>e.filter(e=>e.selection.includes(t)||e.translation.includes(t)||e.originWord.includes(t)||e.context.includes(t)),[t,l]),i=Object(a.useCallback)((e,t)=>ue.groupWords(e,t),[t,r])(r,l?o(t||[],l):t||[]),c=r===_.SameWord?null==i?void 0:i.length:null==t?void 0:t.length;return n.a.createElement(n.a.Fragment,null,n.a.createElement(le,{count:c}),t?n.a.createElement("ul",null,i.map(e=>n.a.createElement("li",{key:e.id},n.a.createElement("h3",null,e.id),n.a.createElement(se,null,e.words.map(e=>n.a.createElement(ce,{key:e.id,word:e})))))):null)});const me=s.a.div`
	flex: 1;
	background-color: #232323;
	color: #fff;
